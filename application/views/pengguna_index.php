						...
						<tr class="text-gray-700 dark:text-gray-400">
							...
							<td class="px-2 py-3">
								<div class="flex items-center space-x-3 text-sm">
									<a href="<?= base_url('pengguna/edit/'.$row['id_user'])?>"
									...
									<a href="<?= base_url('pengguna/hapus/'.$row['id_user'])?>" onClick="return confirm('Apakah Anda Yakin?')"
										class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
										aria-label="Delete">
										<svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
									...
									<a href="<?= base_url('pengguna/reset/'.$row['id_user'])?>" onClick="return confirm('Apakah Anda Yakin?')"
										class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
										aria-label="Delete">
