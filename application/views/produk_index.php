				...
				<div class="mt-4 mb-6">
					...
					<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
						...
						<label class="block mt-4 text-sm">
							...
							<input
								class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
								type="text" name="kode_produk" placeholder="Kode Produk" required />
						</label>
					</div>
				</div>
				...
				<table class="w-full whitespace-no-wrap">
					<thead>
						<tr
							...
							<th class="px-4 py-3">Kode PProduk</th>
						...
						<tr class="text-gray-700 dark:text-gray-400">
							...
							<td class="px-2 py-3">
								<div class="flex items-center space-x-3 text-sm">
									<a href="<?= base_url('produk/edit/'.$row['id_produk'])?>"
									...
									<a href="<?= base_url('produk/hapus/'.$row['id_produk'])?>" onClick="return confirm('Apakah Anda Yakin?')"
										class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
										aria-label="Delete">
										<svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
